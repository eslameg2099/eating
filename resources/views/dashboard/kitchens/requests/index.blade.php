        ...
        @forelse($kitchens as $kitchen)
            <tr>
                ...
                <td style="width: 160px">
                    @include('dashboard.kitchens.requests.partials.actions.show')
                    @include('dashboard.kitchens.partials.actions.edit')
                    @include('dashboard.kitchens.requests.partials.actions.accept')
                    @include('dashboard.kitchens.requests.partials.actions.delete')
                </td>
            </tr>
        @empty
            <tr>
