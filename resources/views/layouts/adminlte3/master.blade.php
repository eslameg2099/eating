...
{{--            </li>--}}
    ...
    <aside class="main-sidebar sidebar-dark-yellow elevation-4" style="background-color: #0c525d;">
        <!-- Brand Logo -->
        <a href="{{ url('/') }}" class="brand-link">
            <img src="{{ app_logo() }}" alt="{{ app_name() }} Logo" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
            <span class="brand-text font-weight-light text-white">{{ app_name() }}</span>
        </a>
