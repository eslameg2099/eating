...
'systen_profit'=>'نسبة مكسب النظام من المطبخ (مئوية)',
        'admin_commission' => 'قيمة عمولة التطبيق من المستخدم ',
        'delivery_cost' => 'تكلفة التوصيل (للكيلو الواحد)',
        'tax_ratio' => 'الضريبة (مئوية)',
        'additional_added_tax' => 'ضريبة القيمة المضافة (مئوية)',
        'name' => 'اسم الموقع',
        '%name%' => 'اسم الموقع',
