...
class SettingController extends Controller
{
    public function index()
    {
        return response()->json([
            ...
            'payments' => [
                'online' => (int)TypePayment::find(2)->active,
                'wallet' => (int)TypePayment::find(1)->active,
                'cache' => (int)TypePayment::find(3)->active,
            ]
        ]);
    }
...
//        return view('dashboard.settings.page', compact('title', 'content'));
    ...
    {
        return response()->json([
                'chef' => Settings::locale()->get('chef-terms'),
                'customer' => Settings::locale()->get('customer-terms'),
                'delegate' => Settings::locale()->get('delegate-terms'),
        ]);
    }
}
