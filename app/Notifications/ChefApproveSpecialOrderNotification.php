...
class ChefApproveSpecialOrderNotification extends Notification
{
    use Queueable;
    ...
    {
        return [
            'title'=> trans("notifications.titles.order-accepted"),
            'body'=> trans("notifications.messages.approve-specialOrder",['user' => $this->special_order->kitchen->user->name]),
