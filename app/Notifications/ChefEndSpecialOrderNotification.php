...
class ChefEndSpecialOrderNotification extends Notification
{
    use Queueable;
    ...
    {
        return [
            'title'=> trans("notifications.titles.end-specialOrder"),
            'body'=> trans("notifications.messages.end-specialOrder",['user' => $this->special_order->kitchen->user->name , 'order_id' => $this->special_order->id]),
