...
class UserApproveSpecialOrderNotification extends Notification
{
    use Queueable;
    ...
    public function toPusher($notifiable)
    {
        return [
            ...
            'body'=> trans("notifications.messages.approve-specialOrder",['user' => $this->special_order->customer->name]),
