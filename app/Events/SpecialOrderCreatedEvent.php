...
class SpecialOrderCreatedEvent implements ShouldBroadcast
{
    ...
    {
        return new PresenceChannel('App.User.'.$this->specialOrder->kitchen->user_id);
    }

    public function broadcastAs()
    {
        return 'new-special-order';
    }
